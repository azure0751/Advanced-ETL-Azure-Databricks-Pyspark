...
val aehConsumerConnString = ConnectionStringBuilder(dbutils.secrets.get(scope = "gws-crimes-aeh", key = "conexion-string"))
...
// MAGIC %md
// MAGIC Create table in the datawarehouse from the portal - with query explorer UI, if it already doesn't exist<br>
// MAGIC
// MAGIC ```
