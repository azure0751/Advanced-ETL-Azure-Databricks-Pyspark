...
val storageAccountName = "sreeramwrkshpdb"
...
// MAGIC %md **Note:** The containers may not already exist in the Blob store so go ahead and create them from Azure portal.
