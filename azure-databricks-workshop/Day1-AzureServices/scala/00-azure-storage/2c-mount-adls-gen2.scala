...
val sourceToBeMounted = "abfss://gwsroot@sreeramwrkshpadl2.dfs.core.windows.net/"

// COMMAND ----------

spark.conf.set("fs.azure.account.key.sreeramwrkshpadl2.dfs.core.windows.net", dbutils.secrets.get(scope = "gws-adlsgen2-storage", key = "storage-acct-key"))
spark.conf.set("fs.azure.createRemoteFileSystemDuringInitialization", "true")
dbutils.fs.ls("abfss://gwsroot@sreeramwrkshpadl2.dfs.core.windows.net/")
...
dbutils.fs.mount(
  source = "abfss://gwsroot@sreeramwrkshpadl2.dfs.core.windows.net/",
...
// MAGIC %fs ls /mnt/workshop-adlsgen2/gwsroot
