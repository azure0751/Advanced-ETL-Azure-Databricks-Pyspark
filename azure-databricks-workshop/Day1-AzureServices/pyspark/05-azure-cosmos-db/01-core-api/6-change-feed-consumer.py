...
cosmosDbReadConfigMap = {
  "Endpoint" : "https://gaianosqldb.documents.azure.com:443/",
  "Masterkey" : "0b8ADchGkfGWXtzg33cfePcty7CAtb58Hd5zTJCxSSs7GmFVY7pDbLGQbJsLenfqTOHcXr5zrixLf7wjYCferw==",
  "Database" : "gws_db",
...
changeFeedDF = spark.readStream.format("com.microsoft.azure.cosmosdb.spark.streaming.CosmosDBSourceProvider").options(**cosmosDbReadConfigMap).load()
...
parsedChangeFeedDF = changeFeedDF.select("case_id","primary_type", "case_year", "case_month", "case_day_of_month")
