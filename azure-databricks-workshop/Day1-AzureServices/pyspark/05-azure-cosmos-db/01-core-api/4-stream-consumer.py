...
consumableDF = partParsedStreamDF.select(get_json_object(partParsedStreamDF['json_payload'], "$.case_id").cast(IntegerType()).alias("case_id"), \
                                         ...
                                         get_json_object(partParsedStreamDF["json_payload"], "$.case_dt_tm").cast(StringType()).alias("case_dt_tm"), \
                                         ...
                                         get_json_object(partParsedStreamDF["json_payload"], "$.case_timestamp").cast(StringType()).alias("case_timestamp"), \
...
query = consumableDF \
  .writeStream \
  .outputMode("append") \
  .format("com.microsoft.azure.cosmosdb.spark.streaming.CosmosDBSinkProvider").options(**cosmosDbWriteConfigMap) \
