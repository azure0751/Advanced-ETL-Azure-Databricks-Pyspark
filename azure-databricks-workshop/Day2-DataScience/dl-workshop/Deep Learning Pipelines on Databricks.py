...
# MAGIC * Databricks Runtime 5.0 ML or above you can skip creating and installing the libraries.
# MAGIC
...
# MAGIC %sh ls /databricks/driver/flower_photos
...
image_df2 = ImageSchema.readImages(sample_img_dir)
#display(image_df)
