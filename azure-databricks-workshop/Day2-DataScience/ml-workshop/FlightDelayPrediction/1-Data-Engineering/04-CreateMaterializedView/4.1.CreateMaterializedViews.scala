...
// DBTITLE 1,Enable DBIO cache at the cluster level
...
matViewDF
      .write
      .mode("overwrite")
      //.partitionBY("") //would be very beneficial to partition parquet data by a key cloumn 
...
// MAGIC %md
// MAGIC
// MAGIC ### 2. Create external table using Spark Data sources
