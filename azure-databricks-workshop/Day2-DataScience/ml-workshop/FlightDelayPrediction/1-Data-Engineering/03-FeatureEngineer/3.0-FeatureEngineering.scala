...
// MAGIC %md
// MAGIC
// MAGIC # Feature Engineering - level set
// MAGIC
// MAGIC ** Feature: **<BR>
...
In our exercise, the features of relevance/importance have been determined ahead of time.  So, we will focus on cleaning up these attributes in preparation of modeling.
