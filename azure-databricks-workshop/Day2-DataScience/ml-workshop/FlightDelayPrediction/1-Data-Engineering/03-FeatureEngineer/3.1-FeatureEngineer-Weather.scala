...
display(sqlContext.sql("select wind_speed from flight_db.weather_history").describe())
...
// MAGIC %md
// MAGIC
// MAGIC ### 4. Create external table using Spark Data sources
