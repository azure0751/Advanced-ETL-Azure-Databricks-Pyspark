...
// MAGIC (1) Copy the source data for carriers in the (transient) staging directory to the raw data directory<BR>
...
// MAGIC /mnt/data/mlw/stagingDir/carrier-master/CarrierMasterData.csv
...
val sourceFile="/mnt/data/mlw/stagingDir/carrier-master/CarrierMasterData.csv"
val destinationDirectory="/mnt/data/mlw/rawDir/master-data/carrier"
...
//Refresh table
sql("REFRESH TABLE flight_db.carrier_master")

//Run statistics on table for performance
sql("ANALYZE TABLE flight_db.carrier_master COMPUTE STATISTICS")
...
// MAGIC %fs head /mnt/data/mlw/rawDir/master-data/carrier/CarrierMasterData.csv
