...
// MAGIC %md
// MAGIC
// MAGIC ### 2. Create an external table using Spark Data Sources
...
// MAGIC airport_id INT,
// MAGIC airport_cd STRING,
// MAGIC airport_nm STRING,
// MAGIC airport_lat STRING,
// MAGIC airport_long STRING
// MAGIC )
// MAGIC USING CSV 
// MAGIC OPTIONS("delimiter" = ",")
// MAGIC LOCATION '/mnt/data/mlw/rawDir/master-data/airport';
